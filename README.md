...
For extra features (GPS location, altitude, speed tracking, advanced calibration, etc.), see **Online Compass – Full Tool**: [online-compass.com](https://online-compass.com/). The full site also provides latitude/longitude and other location data when you allow GPS access.
...
No special setup is needed – just include this code where you want the compass to appear.
